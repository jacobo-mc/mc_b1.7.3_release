...
public class BlockDetectorRail extends BlockRail {
    ...
    public boolean func_228_c(World var1, int var2, int var3, int var4, int var5) {
        if ((var1.func_602_e(var2, var3, var4) & 8) == 0) {
            return false;
        } else {
            return var5 == 1;
        }
    ...
    private void func_27046_f(World var1, int var2, int var3, int var4, int var5) {
        ...
        boolean var7 = false;
        float var8 = 0.125F;
        List var9 = var1.func_657_a(EntityMinecart.class, AxisAlignedBB.func_1161_b((double)((float)var2 + var8), (double)var3, (double)((float)var4 + var8), (double)((float)(var2 + 1) - var8), (double)var3 + 0.25D, (double)((float)(var4 + 1) - var8)));
        if (var9.size() > 0) {
            var7 = true;
        }

        if (var7 && !var6) {
            var1.func_691_b(var2, var3, var4, var5 | 8);
        ...
        if (!var7 && var6) {
            var1.func_691_b(var2, var3, var4, var5 & 7);
            var1.func_611_g(var2, var3, var4, this.field_376_bc);
            var1.func_611_g(var2, var3 - 1, var4, this.field_376_bc);
            var1.func_701_b(var2, var3, var4, var2, var3, var4);
        }
