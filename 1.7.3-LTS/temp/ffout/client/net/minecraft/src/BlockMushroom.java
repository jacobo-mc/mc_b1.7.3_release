...
public class BlockMushroom extends BlockFlower {
    ...
    public void func_208_a(World var1, int var2, int var3, int var4, Random var5) {
        if (var5.nextInt(100) == 0) {
            ...
            if (var1.func_20084_d(var6, var7, var8) && this.func_223_g(var1, var6, var7, var8)) {
                int var10000 = var2 + (var5.nextInt(3) - 1);
                var10000 = var4 + (var5.nextInt(3) - 1);
                if (var1.func_20084_d(var6, var7, var8) && this.func_223_g(var1, var6, var7, var8)) {
                    var1.func_690_d(var6, var7, var8, this.field_376_bc);
                }
            }
        }
    ...
    protected boolean func_269_b(int var1) {
        return Block.field_343_p[var1];
    }

    public boolean func_223_g(World var1, int var2, int var3, int var4) {
        if (var3 >= 0 && var3 < 128) {
            return var1.func_28104_m(var2, var3, var4) < 13 && this.func_269_b(var1.func_600_a(var2, var3 - 1, var4));
        } else {
            return false;
        }
    }
