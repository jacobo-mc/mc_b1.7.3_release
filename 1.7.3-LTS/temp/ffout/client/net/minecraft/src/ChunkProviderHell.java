...
public class ChunkProviderHell implements IChunkProvider {
    ...
    public void func_4058_b(int var1, int var2, byte[] var3) {
        ...
        this.field_4161_q = this.field_4166_l.func_807_a(this.field_4161_q, (double)(var1 * 16), 109.0134D, (double)(var2 * 16), 16, 1, 16, var5, 1.0D, var5);
            ...
            for(int var8 = 0; var8 < 16; ++var8) {
                ...
                for(int var15 = 127; var15 >= 0; --var15) {
                    ...
                    if (var15 >= 127 - this.field_4170_h.nextInt(5)) {
                        var3[var16] = (byte)Block.field_403_A.field_376_bc;
