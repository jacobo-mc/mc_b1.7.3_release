...
public class MapGenCaves extends MapGenBase {
    ...
    protected void func_869_a(int var1, int var2, byte[] var3, double var4, double var6, double var8, float var10, float var11, float var12, int var13, int var14, double var15) {
        ...
        for(boolean var26 = var23.nextInt(6) == 0; var13 < var14; ++var13) {
            double var27 = 1.5D + (double)(MathHelper.func_1106_a((float)var13 * 3.1415927F / (float)var14) * var10 * 1.0F);
            double var29 = var27 * var15;
            float var31 = MathHelper.func_1114_b(var12);
            float var32 = MathHelper.func_1106_a(var12);
            var4 += (double)(MathHelper.func_1114_b(var11) * var31);
            var6 += (double)var32;
            var8 += (double)(MathHelper.func_1106_a(var11) * var31);
            if (var26) {
                var12 *= 0.92F;
            } else {
                var12 *= 0.7F;
            ...
            if (!var52 && var13 == var25 && var10 > 1.0F) {
                this.func_869_a(var1, var2, var3, var4, var6, var8, var23.nextFloat() * 0.5F + 0.5F, var11 - 1.5707964F, var12 / 3.0F, var13, var14, 1.0D);
                this.func_869_a(var1, var2, var3, var4, var6, var8, var23.nextFloat() * 0.5F + 0.5F, var11 + 1.5707964F, var12 / 3.0F, var13, var14, 1.0D);
                return;
            }
            ...
            if (var52 || var23.nextInt(4) != 0) {
                ...
                if (var4 >= var17 - 16.0D - var27 * 2.0D && var8 >= var19 - 16.0D - var27 * 2.0D && var4 <= var17 + 16.0D + var27 * 2.0D && var8 <= var19 + 16.0D + var27 * 2.0D) {
                    int var53 = MathHelper.func_1108_b(var4 - var27) - var1 * 16 - 1;
                    int var34 = MathHelper.func_1108_b(var4 + var27) - var1 * 16 + 1;
                    int var54 = MathHelper.func_1108_b(var6 - var29) - 1;
                    int var36 = MathHelper.func_1108_b(var6 + var29) + 1;
                    int var55 = MathHelper.func_1108_b(var8 - var27) - var2 * 16 - 1;
                    int var38 = MathHelper.func_1108_b(var8 + var27) - var2 * 16 + 1;
                    if (var53 < 0) {
                        var53 = 0;
                    }
                        ...
                        for(int var41 = var55; !var56 && var41 < var38; ++var41) {
                            for(int var42 = var36 + 1; !var56 && var42 >= var54 - 1; --var42) {
                                ...
                                if (var42 >= 0 && var42 < 128) {
                                    if (var3[var43] == Block.field_401_B.field_376_bc || var3[var43] == Block.field_399_C.field_376_bc) {
                                        var56 = true;
                                    }
                                ...
                                if (var57 * var57 + var44 * var44 < 1.0D) {
                                    for(int var48 = var36 - 1; var48 >= var54; --var48) {
                                        ...
                                        if (var49 > -0.7D && var57 * var57 + var49 * var49 + var44 * var44 < 1.0D) {
                                            ...
                                            if (var51 == Block.field_337_v.field_376_bc) {
                                                var47 = true;
                                            }

                                            if (var51 == Block.field_338_u.field_376_bc || var51 == Block.field_336_w.field_376_bc || var51 == Block.field_337_v.field_376_bc) {
                                                if (var48 < 10) {
                                                    var3[var46] = (byte)Block.field_397_D.field_376_bc;
                                                } else {
                                                    var3[var46] = 0;
                                                    if (var47 && var3[var46 - 1] == Block.field_336_w.field_376_bc) {
                                                        var3[var46 - 1] = (byte)Block.field_337_v.field_376_bc;
                                                    }
                                                }
                                            }
                                        }
