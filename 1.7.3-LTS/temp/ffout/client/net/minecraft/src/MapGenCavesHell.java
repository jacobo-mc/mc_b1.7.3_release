        ...
        for(boolean var26 = var23.nextInt(6) == 0; var13 < var14; ++var13) {
            ...
            if (var51 || var23.nextInt(4) != 0) {
                ...
                if (var4 >= var17 - 16.0D - var27 * 2.0D && var8 >= var19 - 16.0D - var27 * 2.0D && var4 <= var17 + 16.0D + var27 * 2.0D && var8 <= var19 + 16.0D + var27 * 2.0D) {
                    int var52 = MathHelper.func_1108_b(var4 - var27) - var1 * 16 - 1;
                    int var34 = MathHelper.func_1108_b(var4 + var27) - var1 * 16 + 1;
                    int var53 = MathHelper.func_1108_b(var6 - var29) - 1;
                    int var36 = MathHelper.func_1108_b(var6 + var29) + 1;
                    int var54 = MathHelper.func_1108_b(var8 - var27) - var2 * 16 - 1;
                        ...
                        for(int var41 = var54; !var55 && var41 < var38; ++var41) {
                            for(int var42 = var36 + 1; !var55 && var42 >= var53 - 1; --var42) {
                                ...
                                if (var42 >= 0 && var42 < 128) {
                                    if (var3[var43] == Block.field_397_D.field_376_bc || var3[var43] == Block.field_395_E.field_376_bc) {
                                        var55 = true;
                                    }
