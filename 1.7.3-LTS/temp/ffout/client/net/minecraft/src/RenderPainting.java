...
public class RenderPainting extends Render {
    ...
    private void func_160_a(EntityPainting var1, float var2, float var3) {
        ...
        int var5 = MathHelper.func_1108_b(var1.field_610_al + (double)(var3 / 16.0F));
        int var6 = MathHelper.func_1108_b(var1.field_609_am);
        if (var1.field_691_a == 0) {
            var4 = MathHelper.func_1108_b(var1.field_611_ak + (double)(var2 / 16.0F));
        }

        if (var1.field_691_a == 1) {
            var6 = MathHelper.func_1108_b(var1.field_609_am - (double)(var2 / 16.0F));
        }
        ...
        float var7 = this.field_191_a.field_1227_g.func_598_c(var4, var5, var6);
