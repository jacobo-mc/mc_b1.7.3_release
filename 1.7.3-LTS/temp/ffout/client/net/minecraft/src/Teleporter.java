...
public class Teleporter {
    ...
    public boolean func_4106_b(World var1, Entity var2) {
        ...
        int var7 = 0;
        int var8 = 0;
        int var9 = MathHelper.func_1108_b(var2.field_611_ak);
        int var10 = MathHelper.func_1108_b(var2.field_609_am);

        double var18;
        for(int var11 = var9 - var3; var11 <= var9 + var3; ++var11) {
            double var12 = (double)var11 + 0.5D - var2.field_611_ak;

            for(int var14 = var10 - var3; var14 <= var10 + var3; ++var14) {
                double var15 = (double)var14 + 0.5D - var2.field_609_am;

                for(int var17 = 127; var17 >= 0; --var17) {
                    if (var1.func_600_a(var11, var17, var14) == Block.field_4047_bf.field_376_bc) {
                        while(var1.func_600_a(var11, var17 - 1, var14) == Block.field_4047_bf.field_376_bc) {
                            --var17;
                        }

                        var18 = (double)var17 + 0.5D - var2.field_610_al;
        ...
        if (var4 >= 0.0D) {
            ...
            if (var1.func_600_a(var6 - 1, var7, var8) == Block.field_4047_bf.field_376_bc) {
                var22 -= 0.5D;
            }
            ...
            if (var1.func_600_a(var6, var7, var8 - 1) == Block.field_4047_bf.field_376_bc) {
                var18 -= 0.5D;
            }
            ...
            var2.func_365_c(var22, var16, var18, var2.field_605_aq, 0.0F);
    ...
    public boolean func_4108_c(World var1, Entity var2) {
        byte var3 = 16;
        double var4 = -1.0D;
        int var6 = MathHelper.func_1108_b(var2.field_611_ak);
        int var7 = MathHelper.func_1108_b(var2.field_610_al);
        int var8 = MathHelper.func_1108_b(var2.field_609_am);
        int var9 = var6;
        int var10 = var7;
        int var11 = var8;
        int var12 = 0;
        ...
        for(var14 = var6 - var3; var14 <= var6 + var3; ++var14) {
            var15 = (double)var14 + 0.5D - var2.field_611_ak;

            for(var17 = var8 - var3; var17 <= var8 + var3; ++var17) {
                var18 = (double)var17 + 0.5D - var2.field_609_am;
                ...
                for(var20 = 127; var20 >= 0; --var20) {
                    if (var1.func_20084_d(var14, var20, var17)) {
                        ...
                        for(var21 = var13; var21 < var13 + 4; ++var21) {
                            ...
                            for(var24 = 0; var24 < 3; ++var24) {
                                for(var25 = 0; var25 < 4; ++var25) {
                                    for(var26 = -1; var26 < 4; ++var26) {
                                        ...
                                        if (var26 < 0 && !var1.func_599_f(var27, var28, var29).func_878_a() || var26 >= 0 && !var1.func_20084_d(var27, var28, var29)) {
                                            continue label293;
                                        }
                                    }
                                }
                            ...
                            var32 = (double)var20 + 0.5D - var2.field_610_al;
                            ...
                            for(var21 = var13; var21 < var13 + 2; ++var21) {
                                ...
                                for(var24 = 0; var24 < 4; ++var24) {
                                    for(var25 = -1; var25 < 4; ++var25) {
                                        ...
                                        if (var25 < 0 && !var1.func_599_f(var26, var27, var28).func_878_a() || var25 >= 0 && !var1.func_20084_d(var26, var27, var28)) {
                                            continue label231;
                                        }
                                    }
                                }
            ...
            for(var20 = -1; var20 <= 1; ++var20) {
                for(var21 = 1; var21 < 3; ++var21) {
                    for(var22 = -1; var22 < 3; ++var22) {
                        ...
                        var34 = var22 < 0;
                        var1.func_690_d(var23, var24, var25, var34 ? Block.field_405_aq.field_376_bc : 0);
                    }
                }
            }
        }
        ...
        for(var20 = 0; var20 < 4; ++var20) {
            ...
            for(var21 = 0; var21 < 4; ++var21) {
                for(var22 = -1; var22 < 4; ++var22) {
                    ...
                    var1.func_690_d(var23, var24, var25, var34 ? Block.field_405_aq.field_376_bc : Block.field_4047_bf.field_376_bc);
                }
            }
            ...
            for(var21 = 0; var21 < 4; ++var21) {
                for(var22 = -1; var22 < 4; ++var22) {
                    ...
                    var24 = var16 + var22;
                    var25 = var17 + (var21 - 1) * var19;
                    var1.func_611_g(var23, var24, var25, var1.func_600_a(var23, var24, var25));
                }
            }
        }
