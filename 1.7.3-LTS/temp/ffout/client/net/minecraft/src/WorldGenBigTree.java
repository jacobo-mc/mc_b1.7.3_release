                ...
                while(true) {
                    ...
                    if (var15 > (double)var4) {
                        ...
                        if (var14 != 0 && var14 != 18) {
                            ...
                            this.field_880_c.func_634_a(var11[0], var11[1], var11[2], var6);
                            ++var13;
                        }
                    }
                }
    ...
    void func_522_a(int[] var1, int[] var2, int var3) {
        ...
        if (var4[var6] != 0) {
            ...
            for(int var16 = var4[var6] + var9; var15 != var16; var15 += var9) {
                var14[var6] = MathHelper.func_1108_b((double)(var1[var6] + var15) + 0.5D);
                var14[var7] = MathHelper.func_1108_b((double)var1[var7] + (double)var15 * var10 + 0.5D);
                var14[var8] = MathHelper.func_1108_b((double)var1[var8] + (double)var15 * var12 + 0.5D);
                this.field_880_c.func_634_a(var14[0], var14[1], var14[2], var3);
            }
    ...
    int func_524_a(int[] var1, int[] var2) {
        ...
        if (var3[var5] == 0) {
            ...
            for(var15 = var3[var5] + var8; var14 != var15; var14 += var8) {
                ...
                var13[var6] = MathHelper.func_1108_b((double)var1[var6] + (double)var14 * var9);
                var13[var7] = MathHelper.func_1108_b((double)var1[var7] + (double)var14 * var11);
