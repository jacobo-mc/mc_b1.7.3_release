        ...
        for(var8 = 0; var8 < 16; ++var8) {
            for(var32 = 0; var32 < 16; ++var32) {
                for(var10 = 0; var10 < 8; ++var10) {
                    ...
                    if (var33) {
                        Material var12 = var1.func_599_f(var3 + var8, var4 + var10, var5 + var32);
                        if (var10 >= 4 && var12.func_879_d()) {
                            return false;
                        }

                        if (var10 < 4 && !var12.func_878_a() && var1.func_600_a(var3 + var8, var4 + var10, var5 + var32) != this.field_15235_a) {
                            return false;
                        }
                    }
                }
            ...
            for(var32 = 0; var32 < 16; ++var32) {
                for(var10 = 0; var10 < 8; ++var10) {
                    if (var6[(var8 * 16 + var32) * 8 + var10]) {
                        var1.func_634_a(var3 + var8, var4 + var10, var5 + var32, var10 >= 4 ? 0 : this.field_15235_a);
                    }
                }
            }
        }
        ...
        for(var8 = 0; var8 < 16; ++var8) {
            for(var32 = 0; var32 < 16; ++var32) {
                for(var10 = 4; var10 < 8; ++var10) {
                    if (var6[(var8 * 16 + var32) * 8 + var10] && var1.func_600_a(var3 + var8, var4 + var10 - 1, var5 + var32) == Block.field_336_w.field_376_bc && var1.func_641_a(EnumSkyBlock.Sky, var3 + var8, var4 + var10, var5 + var32) > 0) {
                        var1.func_634_a(var3 + var8, var4 + var10 - 1, var5 + var32, Block.field_337_v.field_376_bc);
                    }
                }
            }
        }
        ...
        if (Block.field_345_n[this.field_15235_a].field_356_bn == Material.field_1331_g) {
            for(var8 = 0; var8 < 16; ++var8) {
                for(var32 = 0; var32 < 16; ++var32) {
                    for(var10 = 0; var10 < 8; ++var10) {
                        var33 = !var6[(var8 * 16 + var32) * 8 + var10] && (var8 < 15 && var6[((var8 + 1) * 16 + var32) * 8 + var10] || var8 > 0 && var6[((var8 - 1) * 16 + var32) * 8 + var10] || var32 < 15 && var6[(var8 * 16 + var32 + 1) * 8 + var10] || var32 > 0 && var6[(var8 * 16 + (var32 - 1)) * 8 + var10] || var10 < 7 && var6[(var8 * 16 + var32) * 8 + var10 + 1] || var10 > 0 && var6[(var8 * 16 + var32) * 8 + (var10 - 1)]);
                        if (var33 && (var10 < 4 || var2.nextInt(2) != 0) && var1.func_599_f(var3 + var8, var4 + var10, var5 + var32).func_878_a()) {
                            var1.func_634_a(var3 + var8, var4 + var10, var5 + var32, Block.field_338_u.field_376_bc);
                        }
                    }
                }
            }
