            ...
            if (!var10) {
                ...
                if ((var11 == Block.field_337_v.field_376_bc || var11 == Block.field_336_w.field_376_bc) && var4 < 128 - var6 - 1) {
                    ...
                    for(var13 = var4 + var6; var13 >= var4 + var7; --var13) {
                        for(var14 = var3 - var18; var14 <= var3 + var18; ++var14) {
                            ...
                            for(int var16 = var5 - var18; var16 <= var5 + var18; ++var16) {
                                ...
                                if ((Math.abs(var15) != var18 || Math.abs(var17) != var18 || var18 <= 0) && !Block.field_343_p[var1.func_600_a(var14, var13, var16)]) {
                                    var1.func_643_a(var14, var13, var16, Block.field_384_L.field_376_bc, 1);
                                }
                            }
                        }
                    ...
                    for(var13 = 0; var13 < var6 - 1; ++var13) {
                        var14 = var1.func_600_a(var3, var4 + var13, var5);
                        if (var14 == 0 || var14 == Block.field_384_L.field_376_bc) {
                            var1.func_643_a(var3, var4 + var13, var5, Block.field_385_K.field_376_bc, 1);
                        }
                    }
