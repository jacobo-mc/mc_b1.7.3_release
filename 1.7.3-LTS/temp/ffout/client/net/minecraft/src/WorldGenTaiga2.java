    ...
    public boolean func_516_a(World var1, Random var2, int var3, int var4, int var5) {
        ...
        if (var4 >= 1 && var4 + var6 + 1 <= 128) {
                ...
                for(var13 = var3 - var21; var13 <= var3 + var21 && var10; ++var13) {
                    for(int var14 = var5 - var21; var14 <= var5 + var21 && var10; ++var14) {
                        if (var11 >= 0 && var11 < 128) {
                            var15 = var1.func_600_a(var13, var11, var14);
            ...
            if (!var10) {
                ...
                var11 = var1.func_600_a(var3, var4 - 1, var5);
                if ((var11 == Block.field_337_v.field_376_bc || var11 == Block.field_336_w.field_376_bc) && var4 < 128 - var6 - 1) {
                    ...
                    for(var15 = 0; var15 <= var8; ++var15) {
                        ...
                        for(var17 = var3 - var21; var17 <= var3 + var21; ++var17) {
                            ...
                            for(int var19 = var5 - var21; var19 <= var5 + var21; ++var19) {
                                ...
                                if ((Math.abs(var18) != var21 || Math.abs(var20) != var21 || var21 <= 0) && !Block.field_343_p[var1.func_600_a(var17, var16, var19)]) {
                                    var1.func_643_a(var17, var16, var19, Block.field_384_L.field_376_bc, 1);
                                }
                            }
                        }
                    ...
                    for(var16 = 0; var16 < var6 - var15; ++var16) {
                        var17 = var1.func_600_a(var3, var4 + var16, var5);
                        if (var17 == 0 || var17 == Block.field_384_L.field_376_bc) {
                            var1.func_643_a(var3, var4 + var16, var5, Block.field_385_K.field_376_bc, 1);
                        }
                    }
