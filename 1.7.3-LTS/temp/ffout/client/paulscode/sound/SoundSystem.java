...
public class SoundSystem {
    ...
    public boolean newLibrary(Class var1) {
        ...
        SoundSystemException var3;
        if (!initialized(false, false)) {
            var3 = new SoundSystemException(this.className + " did not load after 30 seconds.", 4);
            lastException(true, var3);
            throw var3;
        } else {
            var3 = lastException(false, (SoundSystemException)null);
            if (var3 != null) {
                throw var3;
            } else {
                return true;
