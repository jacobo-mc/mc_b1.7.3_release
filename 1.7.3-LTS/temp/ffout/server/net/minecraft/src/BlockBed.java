...
public class BlockBed extends Block {
    ...
    public BlockBed(int var1) {
        super(var1, 134, Material.field_4217_k);
        this.func_22017_f();
    }
    ...
    public boolean func_246_a(World var1, int var2, int var3, int var4, EntityPlayer var5) {
        if (var1.field_792_x) {
            ...
            if (!func_22020_d(var6)) {
                ...
                var6 = var1.func_446_b(var2, var3, var4);
            }

            if (!var1.field_4272_q.func_28108_d()) {
                ...
                var1.func_12015_a((Entity)null, (double)((float)var2 + 0.5F), (double)((float)var3 + 0.5F), (double)((float)var4 + 0.5F), 5.0F, true);
                return true;
            } else {
                if (func_22018_f(var6)) {
                    EntityPlayer var14 = null;
                    Iterator var8 = var1.field_805_k.iterator();

                    while(var8.hasNext()) {
                        EntityPlayer var9 = (EntityPlayer)var8.next();
                        if (var9.func_22057_E()) {
                            ChunkCoordinates var10 = var9.field_21901_b;
                            if (var10.field_22216_a == var2 && var10.field_529_a == var3 && var10.field_528_b == var4) {
                                var14 = var9;
                            }
                        }
                    }
                ...
                EnumStatus var15 = var5.func_22060_a(var2, var3, var4);
    ...
    public int func_22009_a(int var1, int var2) {
        if (var1 == 0) {
            ...
            if (func_22020_d(var2)) {
                if (var4 == 2) {
                    return this.field_575_bb + 2 + 16;
                } else {
                    return var4 != 5 && var4 != 4 ? this.field_575_bb + 1 : this.field_575_bb + 1 + 16;
                }
            } else if (var4 == 3) {
                return this.field_575_bb - 1 + 16;
            } else {
                return var4 != 5 && var4 != 4 ? this.field_575_bb : this.field_575_bb + 16;
            }
        }
    }
    ...
    public void func_234_b(World var1, int var2, int var3, int var4, int var5) {
        ...
        int var7 = func_22019_c(var6);
        if (func_22020_d(var6)) {
            if (var1.func_444_a(var2 - field_22023_a[var7][0], var3, var4 - field_22023_a[var7][1]) != this.field_573_bc) {
                var1.func_508_d(var2, var3, var4, 0);
            }
        } else if (var1.func_444_a(var2 + field_22023_a[var7][0], var3, var4 + field_22023_a[var7][1]) != this.field_573_bc) {
            var1.func_508_d(var2, var3, var4, 0);
            if (!var1.field_792_x) {
    ...
    public int func_252_a(int var1, Random var2) {
        return func_22020_d(var1) ? 0 : Item.field_22008_aY.field_234_aS;
    }

    private void func_22017_f() {
        this.func_229_a(0.0F, 0.0F, 0.0F, 1.0F, 0.5625F, 1.0F);
    }
    ...
    public static void func_22022_a(World var0, int var1, int var2, int var3, boolean var4) {
        int var5 = var0.func_446_b(var1, var2, var3);
        if (var4) {
            var5 |= 4;
        } else {
            var5 &= -5;
        ...
        var0.func_511_b(var1, var2, var3, var5);
    }
        ...
        for(int var7 = 0; var7 <= 1; ++var7) {
            ...
            for(int var12 = var8; var12 <= var10; ++var12) {
                for(int var13 = var9; var13 <= var11; ++var13) {
                    if (var0.func_445_d(var12, var2 - 1, var13) && var0.func_20111_e(var12, var2, var13) && var0.func_20111_e(var12, var2 + 1, var13)) {
                        if (var4 <= 0) {
