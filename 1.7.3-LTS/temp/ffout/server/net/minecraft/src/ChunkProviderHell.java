...
public class ChunkProviderHell implements IChunkProvider {
                        ...
                        for(int var41 = 0; var41 < 4; ++var41) {
                            ...
                            for(int var50 = 0; var50 < 4; ++var50) {
                                ...
                                if (var11 * 8 + var30 < var5) {
                                    var51 = Block.field_592_E.field_573_bc;
                                }

                                if (var46 > 0.0D) {
                                    var51 = Block.field_4050_bc.field_573_bc;
                                }
    ...
    public void func_4061_b(int var1, int var2, byte[] var3) {
        ...
        this.field_4232_q = this.field_4237_l.func_648_a(this.field_4232_q, (double)(var1 * 16), 109.0134D, (double)(var2 * 16), 16, 1, 16, var5, 1.0D, var5);
        ...
        for(int var7 = 0; var7 < 16; ++var7) {
            for(int var8 = 0; var8 < 16; ++var8) {
                ...
                int var12 = -1;
                byte var13 = (byte)Block.field_4050_bc.field_573_bc;
                byte var14 = (byte)Block.field_4050_bc.field_573_bc;

                for(int var15 = 127; var15 >= 0; --var15) {
                    int var16 = (var8 * 16 + var7) * 128 + var15;
                    if (var15 >= 127 - this.field_4241_h.nextInt(5)) {
                        var3[var16] = (byte)Block.field_4064_A.field_573_bc;
                        ...
                        if (var17 == 0) {
                            var12 = -1;
                        } else if (var17 == Block.field_4050_bc.field_573_bc) {
                            if (var12 == -1) {
                                if (var11 <= 0) {
                                    var13 = 0;
                                    var14 = (byte)Block.field_4050_bc.field_573_bc;
                                } else if (var15 >= var4 - 4 && var15 <= var4 + 1) {
                                    var13 = (byte)Block.field_4050_bc.field_573_bc;
                                    var14 = (byte)Block.field_4050_bc.field_573_bc;
                                    if (var10) {
                                        var13 = (byte)Block.field_4062_G.field_573_bc;
                                    }
                                    ...
                                    if (var9) {
                                        var13 = (byte)Block.field_4048_bd.field_573_bc;
                                    }

                                    if (var9) {
                                        var14 = (byte)Block.field_4048_bd.field_573_bc;
                                    }
                                }

                                if (var15 < var4 && var13 == 0) {
                                    var13 = (byte)Block.field_592_E.field_573_bc;
                                }
    ...
    public void func_4055_a(IChunkProvider var1, int var2, int var3) {
        ...
        for(var6 = 0; var6 < 8; ++var6) {
            ...
            (new WorldGenHellLava(Block.field_594_D.field_573_bc)).func_419_a(this.field_4235_n, this.field_4241_h, var7, var8, var9);
        }
        ...
        for(var7 = 0; var7 < var6; ++var7) {
            ...
            (new WorldGenFire()).func_419_a(this.field_4235_n, this.field_4241_h, var8, var9, var10);
        }
        ...
        for(var7 = 0; var7 < var6; ++var7) {
            ...
            var9 = this.field_4241_h.nextInt(120) + 4;
            var10 = var5 + this.field_4241_h.nextInt(16) + 8;
            (new WorldGenGlowStone1()).func_419_a(this.field_4235_n, this.field_4241_h, var8, var9, var10);
        }
        ...
        for(var7 = 0; var7 < 10; ++var7) {
            ...
            var10 = var5 + this.field_4241_h.nextInt(16) + 8;
            (new WorldGenGlowStone2()).func_419_a(this.field_4235_n, this.field_4241_h, var8, var9, var10);
        }
        ...
        if (this.field_4241_h.nextInt(1) == 0) {
            ...
            var9 = var5 + this.field_4241_h.nextInt(16) + 8;
            (new WorldGenFlowers(Block.field_4070_ag.field_573_bc)).func_419_a(this.field_4235_n, this.field_4241_h, var7, var8, var9);
        }
        ...
        if (this.field_4241_h.nextInt(1) == 0) {
            ...
            var8 = this.field_4241_h.nextInt(128);
            var9 = var5 + this.field_4241_h.nextInt(16) + 8;
            (new WorldGenFlowers(Block.field_4069_ah.field_573_bc)).func_419_a(this.field_4235_n, this.field_4241_h, var7, var8, var9);
        }
