...
public class ItemMap extends ItemMapBase {
    ...
    public MapData func_28023_a(ItemStack var1, World var2) {
        (new StringBuilder()).append("map_").append(var1.func_21125_h()).toString();
        MapData var4 = (MapData)var2.func_28103_a(MapData.class, "map_" + var1.func_21125_h());
        if (var4 == null) {
            var1.func_28145_b(var2.func_28104_b("map"));
            String var3 = "map_" + var1.func_21125_h();
            var4 = new MapData(var3);
            var4.field_28164_b = var2.func_22081_n().func_22184_c();
            var4.field_28163_c = var2.func_22081_n().func_22189_e();
            var4.field_28161_e = 3;
            var4.field_28162_d = (byte)var2.field_4272_q.field_6165_g;
            var4.func_28146_a();
    ...
    public void func_28024_a(World var1, Entity var2, MapData var3) {
        if (var1.field_4272_q.field_6165_g == var3.field_28162_d) {
            short var4 = 128;
            short var5 = 128;
            int var6 = 1 << var3.field_28161_e;
            int var7 = var3.field_28164_b;
            int var8 = var3.field_28163_c;
            int var9 = MathHelper.func_584_b(var2.field_322_l - (double)var7) / var6 + var4 / 2;
            int var10 = MathHelper.func_584_b(var2.field_320_n - (double)var8) / var6 + var5 / 2;
            int var11 = 128 / var6;
            if (var1.field_4272_q.field_4306_c) {
                var11 /= 2;
            }
                ...
                if ((var12 & 15) == (var3.field_28159_g & 15)) {
                    ...
                    for(int var17 = var10 - var11 - 1; var17 < var10 + var11; ++var17) {
                        if (var12 >= 0 && var17 >= -1 && var12 < var4 && var17 < var5) {
                            ...
                            Chunk var27 = var1.func_492_a(var21, var22);
                            int var28 = var21 & 15;
                            int var29 = var22 & 15;
                            int var30 = 0;
                            double var31 = 0.0D;
                            ...
                            if (var1.field_4272_q.field_4306_c) {
                                ...
                                int var10001;
                                if ((var33 >> 20 & 1) == 0) {
                                    var10001 = Block.field_533_w.field_573_bc;
                                    var26[var10001] += 10;
                                } else {
                                    var10001 = Block.field_535_u.field_573_bc;
                                    var26[var10001] += 10;
                                }
                                ...
                                for(var33 = 0; var33 < var6; ++var33) {
                                    for(var34 = 0; var34 < var6; ++var34) {
                                        var35 = var27.func_337_b(var33 + var28, var34 + var29) + 1;
                                        int var36 = 0;
                                        if (var35 > 1) {
                                            boolean var37 = false;
                                            ...
                                            while(true) {
                                                var37 = true;
                                                var36 = var27.func_344_a(var33 + var28, var35 - 1, var34 + var29);
                                                if (var36 == 0) {
                                                    var37 = false;
                                                } else if (var35 > 0 && var36 > 0 && Block.field_542_n[var36].field_553_bn.field_28131_A == MapColor.field_28199_b) {
                                                    var37 = false;
                                                }
                                                ...
                                                if (var37) {
                                                    if (var36 == 0 || !Block.field_542_n[var36].field_553_bn.func_217_d()) {
                                                        break;
                                                    }
                                                    ...
                                                    while(true) {
                                                        int var43 = var27.func_344_a(var33 + var28, var38--, var34 + var29);
                                                        ++var30;
                                                        if (var38 <= 0 || var43 == 0 || !Block.field_542_n[var43].field_553_bn.func_217_d()) {
                                                            break label164;
                                                        }
                                                    }
                                                }
                            ...
                            var38 = 0;
                            if (var34 > 0) {
                                MapColor var44 = Block.field_542_n[var34].field_553_bn.field_28131_A;
    ...
    public void func_28020_c(ItemStack var1, World var2, EntityPlayer var3) {
        var1.func_28145_b(var2.func_28104_b("map"));
        String var4 = "map_" + var1.func_21125_h();
        MapData var5 = new MapData(var4);
        var2.func_28102_a(var4, var5);
        var5.field_28164_b = MathHelper.func_584_b(var3.field_322_l);
        var5.field_28163_c = MathHelper.func_584_b(var3.field_320_n);
        var5.field_28161_e = 3;
        var5.field_28162_d = (byte)var2.field_4272_q.field_6165_g;
        var5.func_28146_a();
    }
    ...
    public Packet func_28022_b(ItemStack var1, World var2, EntityPlayer var3) {
        ...
        return var4 == null ? null : new Packet131MapData((short)Item.field_28021_bb.field_234_aS, (short)var1.func_21125_h(), var4);
    }
}
