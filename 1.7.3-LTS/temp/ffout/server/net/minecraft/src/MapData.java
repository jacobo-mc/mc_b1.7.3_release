...
public class MapData extends MapDataBase {
    ...
    public void func_28148_a(NBTTagCompound var1) {
        this.field_28162_d = var1.func_408_b("dimension");
        this.field_28164_b = var1.func_395_d("xCenter");
        this.field_28163_c = var1.func_395_d("zCenter");
        this.field_28161_e = var1.func_408_b("scale");
        ...
        short var2 = var1.func_406_c("width");
        short var3 = var1.func_406_c("height");
        if (var2 == 128 && var3 == 128) {
            this.field_28160_f = var1.func_400_i("colors");
        } else {
            byte[] var4 = var1.func_400_i("colors");
    ...
    public void func_28147_b(NBTTagCompound var1) {
        var1.func_409_a("dimension", this.field_28162_d);
        var1.func_405_a("xCenter", this.field_28164_b);
        var1.func_405_a("zCenter", this.field_28163_c);
        var1.func_409_a("scale", this.field_28161_e);
        var1.func_394_a("width", (short)128);
        var1.func_394_a("height", (short)128);
        var1.func_391_a("colors", this.field_28160_f);
    }
    ...
    public void func_28155_a(EntityPlayer var1, ItemStack var2) {
        ...
        for(int var14 = 0; var14 < this.field_28158_h.size(); ++var14) {
            ...
            if (!var4.field_28120_a.field_304_B && var4.field_28120_a.field_416_aj.func_28010_c(var2)) {
                float var5 = (float)(var4.field_28120_a.field_322_l - (double)this.field_28164_b) / (float)(1 << this.field_28161_e);
                float var6 = (float)(var4.field_28120_a.field_320_n - (double)this.field_28163_c) / (float)(1 << this.field_28161_e);
                byte var7 = 64;
                byte var8 = 64;
                if (var5 >= (float)(-var7) && var6 >= (float)(-var8) && var5 <= (float)var7 && var6 <= (float)var8) {
                    ...
                    byte var12 = (byte)((int)((double)(var1.field_316_r * 16.0F / 360.0F) + 0.5D));
                    if (this.field_28162_d < 0) {
                        int var13 = this.field_28159_g / 10;
                        var12 = (byte)(var13 * var13 * 34187121 + var13 * 121 >> 15 & 15);
                    }

                    if (var4.field_28120_a.field_4110_as == this.field_28162_d) {
