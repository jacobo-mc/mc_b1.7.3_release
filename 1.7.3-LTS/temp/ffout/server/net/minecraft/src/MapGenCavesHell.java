        ...
        for(boolean var26 = var23.nextInt(6) == 0; var13 < var14; ++var13) {
            ...
            if (var51 || var23.nextInt(4) != 0) {
                ...
                if (var4 >= var17 - 16.0D - var27 * 2.0D && var8 >= var19 - 16.0D - var27 * 2.0D && var4 <= var17 + 16.0D + var27 * 2.0D && var8 <= var19 + 16.0D + var27 * 2.0D) {
                    int var52 = MathHelper.func_584_b(var4 - var27) - var1 * 16 - 1;
                    int var34 = MathHelper.func_584_b(var4 + var27) - var1 * 16 + 1;
                    int var53 = MathHelper.func_584_b(var6 - var29) - 1;
                    int var36 = MathHelper.func_584_b(var6 + var29) + 1;
                    int var54 = MathHelper.func_584_b(var8 - var27) - var2 * 16 - 1;
                        ...
                        for(int var41 = var54; !var55 && var41 < var38; ++var41) {
                            for(int var42 = var36 + 1; !var55 && var42 >= var53 - 1; --var42) {
                                ...
                                if (var42 >= 0 && var42 < 128) {
                                    if (var3[var43] == Block.field_594_D.field_573_bc || var3[var43] == Block.field_592_E.field_573_bc) {
                                        var55 = true;
                                    }
                            ...
                            for(var43 = var54; var43 < var38; ++var43) {
                                ...
                                for(int var47 = var36 - 1; var47 >= var53; --var47) {
                                    ...
                                    if (var48 > -0.7D && var56 * var56 + var48 * var48 + var44 * var44 < 1.0D) {
                                        ...
                                        if (var50 == Block.field_4050_bc.field_573_bc || var50 == Block.field_533_w.field_573_bc || var50 == Block.field_534_v.field_573_bc) {
                                            var3[var46] = 0;
                                        }
                                    }
