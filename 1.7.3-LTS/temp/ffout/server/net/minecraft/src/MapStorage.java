            ...
            if (this.field_28180_a != null) {
                try {
                    ...
                    if (var4 != null && var4.exists()) {
                        ...
                        var5.close();
                        var3.func_28148_a(var6.func_397_j("data"));
                    }
        ...
        if (this.field_28180_a != null) {
            try {
                ...
                if (var2 != null) {
                    ...
                    var4.func_392_a("data", var3);
                    FileOutputStream var5 = new FileOutputStream(var2);
                    CompressedStreamTools.func_769_a(var4, var5);
                    var5.close();
                }
            ...
            if (var1 != null && var1.exists()) {
                ...
                while(var4.hasNext()) {
                    ...
                    if (var5 instanceof NBTTagShort) {
                        ...
                        String var7 = var6.func_384_c();
                        short var8 = var6.field_734_a;
