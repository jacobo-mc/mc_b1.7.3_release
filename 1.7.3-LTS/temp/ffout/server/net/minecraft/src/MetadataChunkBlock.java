            ...
            for(int var10 = this.field_956_b; var10 <= this.field_960_e; ++var10) {
                for(int var11 = this.field_961_d; var11 <= this.field_958_g; ++var11) {
                    ...
                    if (var8 && var12 == var6 && var13 == var7) {
                        ...
                        var14 = var1.func_21118_a(var10, 0, var11, 1);
                        if (var14) {
                            Chunk var15 = var1.func_525_b(var10 >> 4, var11 >> 4);
                    ...
                    if (var14) {
                        ...
                        for(int var27 = this.field_962_c; var27 <= this.field_959_f; ++var27) {
                            int var16 = var1.func_512_a(this.field_957_a, var10, var27, var11);
                            boolean var17 = false;
                            int var18 = var1.func_444_a(var10, var27, var11);
                            int var19 = Block.field_538_r[var18];
                            if (var19 == 0) {
                                var19 = 1;
                            }
                            ...
                            if (this.field_957_a == EnumSkyBlock.Sky) {
                                if (var1.func_475_i(var10, var27, var11)) {
                                    var20 = 15;
                                }
                            } else if (this.field_957_a == EnumSkyBlock.Block) {
                                var20 = Block.field_536_t[var18];
                            }
                            ...
                            if (var19 >= 15 && var20 == 0) {
                                ...
                                var21 = var1.func_512_a(this.field_957_a, var10 - 1, var27, var11);
                                int var22 = var1.func_512_a(this.field_957_a, var10 + 1, var27, var11);
                                int var23 = var1.func_512_a(this.field_957_a, var10, var27 - 1, var11);
                                int var24 = var1.func_512_a(this.field_957_a, var10, var27 + 1, var11);
                                int var25 = var1.func_512_a(this.field_957_a, var10, var27, var11 - 1);
                                int var26 = var1.func_512_a(this.field_957_a, var10, var27, var11 + 1);
                                var28 = var21;
                                if (var22 > var21) {
                                    var28 = var22;
                                }
                            ...
                            if (var16 != var28) {
                                var1.func_529_b(this.field_957_a, var10, var27, var11, var28);
                                var21 = var28 - 1;
                                if (var21 < 0) {
                                    var21 = 0;
                                }

                                var1.func_4069_a(this.field_957_a, var10 - 1, var27, var11, var21);
                                var1.func_4069_a(this.field_957_a, var10, var27 - 1, var11, var21);
                                var1.func_4069_a(this.field_957_a, var10, var27, var11 - 1, var21);
