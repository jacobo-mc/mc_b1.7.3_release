...
class NetworkAcceptThread extends Thread {
    // $FF: synthetic field
    final MinecraftServer field_986_a;
    // $FF: synthetic field
            ...
            try {
                ...
                if (var2 != null) {
                    ...
                    if (var1.containsKey(var3) && !"127.0.0.1".equals(var3.getHostAddress()) && System.currentTimeMillis() - (Long)var1.get(var3) < 5000L) {
                        ...
                        var1.put(var3, System.currentTimeMillis());
                        NetLoginHandler var4 = new NetLoginHandler(this.field_986_a, var2, "Connection #" + NetworkListenThread.func_712_b(this.field_985_b));
