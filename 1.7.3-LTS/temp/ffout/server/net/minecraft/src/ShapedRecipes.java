...
public class ShapedRecipes implements IRecipe {
    ...
    public ShapedRecipes(int var1, int var2, ItemStack[] var3, ItemStack var4) {
        this.field_21141_a = var4.field_855_c;
        ...
        for(int var5 = 0; var5 < 3; ++var5) {
            for(int var6 = 0; var6 < 3; ++var6) {
                ...
                if (var10 != null || var9 != null) {
                    ...
                    if (var9.field_855_c != var10.field_855_c) {
                        return false;
                    }

                    if (var9.func_21125_h() != -1 && var9.func_21125_h() != var10.func_21125_h()) {
                        return false;
                    }
                }
            }
    ...
    public ItemStack func_21136_b(InventoryCrafting var1) {
        return new ItemStack(this.field_21142_e.field_855_c, this.field_21142_e.field_853_a, this.field_21142_e.func_21125_h());
    }
