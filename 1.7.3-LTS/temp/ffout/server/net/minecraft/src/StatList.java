...
public class StatList {
    ...
    public static StatBase field_25095_x;
    public static StatBase[] field_25094_y;
    ...
    public static void func_25091_c() {
        if (field_25101_D && field_25099_E) {
            ...
            Iterator var1 = CraftingManager.func_20151_a().func_25126_b().iterator();

            while(var1.hasNext()) {
                IRecipe var2 = (IRecipe)var1.next();
                var0.add(var2.func_25077_b().field_855_c);
            }

            var1 = FurnaceRecipes.func_21162_a().func_25127_b().values().iterator();

            while(var1.hasNext()) {
                ItemStack var4 = (ItemStack)var1.next();
                var0.add(var4.field_855_c);
            }
            ...
            while(var1.hasNext()) {
                ...
                if (Item.field_176_c[var5] != null) {
                    String var3 = StatCollector.func_25135_a("stat.craftItem", Item.field_176_c[var5].func_25006_i());
    ...
    static {
        ...
        field_25106_q = (new StatBasic(2010, StatCollector.func_25136_a("stat.jump"))).func_27052_e().func_27053_d();
        field_25103_r = (new StatBasic(2011, StatCollector.func_25136_a("stat.drop"))).func_27052_e().func_27053_d();
        field_25102_s = (new StatBasic(2020, StatCollector.func_25136_a("stat.damageDealt"))).func_27053_d();
        field_25100_t = (new StatBasic(2021, StatCollector.func_25136_a("stat.damageTaken"))).func_27053_d();
        field_25098_u = (new StatBasic(2022, StatCollector.func_25136_a("stat.deaths"))).func_27053_d();
        field_25097_v = (new StatBasic(2023, StatCollector.func_25136_a("stat.mobKills"))).func_27053_d();
        field_25096_w = (new StatBasic(2024, StatCollector.func_25136_a("stat.playerKills"))).func_27053_d();
        field_25095_x = (new StatBasic(2025, StatCollector.func_25136_a("stat.fishCaught"))).func_27053_d();
        field_25094_y = func_25089_a("stat.mineBlock", 16777216);
