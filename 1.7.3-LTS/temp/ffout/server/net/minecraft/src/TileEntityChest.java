...
public class TileEntityChest extends TileEntity implements IInventory {
    ...
    public ItemStack func_20069_a(int var1, int var2) {
        if (this.field_494_e[var1] != null) {
            ItemStack var3;
            if (this.field_494_e[var1].field_853_a <= var2) {
                var3 = this.field_494_e[var1];
                this.field_494_e[var1] = null;
                this.func_183_c();
                return var3;
            } else {
                var3 = this.field_494_e[var1].func_20118_a(var2);
                if (this.field_494_e[var1].field_853_a == 0) {
                    this.field_494_e[var1] = null;
                }
    ...
    public void func_188_b(NBTTagCompound var1) {
        ...
        for(int var3 = 0; var3 < this.field_494_e.length; ++var3) {
            if (this.field_494_e[var3] != null) {
                ...
                this.field_494_e[var3].func_570_a(var4);
